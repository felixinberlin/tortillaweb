            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className={`p-4 rounded-xl border text-left transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 ${
                    hasOnion
              ...
              <div className="grid md:grid-cols-3 gap-3">
                {[
                  ...
                  <button
                    ...
                    className={`p-3.5 rounded-xl border text-left transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 ${
                      doneness === item.id
                        ? "border-amber-600 bg-amber-50/50 dark:bg-amber-950/20 ring-2 ring-amber-600/30"
                        : "border-border hover:border-muted-foreground/30"
                    }`}
